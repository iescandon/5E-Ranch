    ...
    >
        <h3 className='text-xs lg:text-sm uppercase'>{content.contactSubtitle ? content.contactSubtitle : undefined}</h3>
          ...
          <div className="flex justify-end mt-4">
            <button className="bg-black text-white p-3 mt-2 md:mt-4 uppercase" disabled={isSubmitting}>{content.contactButtonText ? content.contactButtonText : "Send it"}</button>
          </div>
      {toastState.msg && (
        <p
