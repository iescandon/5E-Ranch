    ...
    <section>
      <div className='relative top-0 left-0 h-[550px] md:h-[450px] lg:h-[600px]'>
        ...
        <div className='absolute inset-0 bg-gradient-to-b from-transparent to-black from-40% flex flex-col items-center justify-center'>
          ...
          <p className="text-4xl lg:text-5xl text-white font-extrabold text-center drop-shadow-md font-jakarta w-[250px] md:w-[600px] lg:w-[800px]">Bringing naturally and ethically raised beef to your table</p>
